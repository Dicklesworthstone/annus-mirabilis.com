...
export async function evaluatorSources() {
  ...
  seen.set(
    "scripts/generate-observation.mjs",
    await readFile(resolve(root, "scripts/generate-observation.mjs"), "utf8"),
  );
...
export async function generateLab() {
  ...
  await writeFile(
    resolve(root, "src/generated/bm08-example.json"),
    `${JSON.stringify(example, null, 2)}\n`,
  );
  await writeFile(
    resolve(root, "src/generated/bm08-provenance.ts"),
    `// Generated by scripts/generate-observation.mjs; do not edit.\nexport const BM08_SOURCE_DIGEST = ${JSON.stringify(sourceDigest)};\n`,
  );
  await writeFile(
    resolve(root, "src/generated/bm08-sources.json"),
