/**
 * Tests for ThreeStudioScene (am-scaf-extract-ui-components-c31).
 */
...
const { classifySingleTouchGesture, createGlowPointTexture, TOUCH_ORBIT_THRESHOLD_PX } =
  await import("./ThreeStudioScene.ts");

const THREE_DIRECTORY = join(process.cwd(), "src/visuals/three");
