...
export function GlossReasoningToggle({ initiallyChecked = false }: {
  initiallyChecked?: boolean;
}) {
  return <label className="reasoning-toggle-label">
    <input type="checkbox" data-toggle-reasoning="true" defaultChecked={initiallyChecked}
      onChange={event => {
