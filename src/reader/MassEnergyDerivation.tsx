...
import { LazyLinearProofExplorer } from "./lazyIslands.tsx";

/** Only the small pre-rendered proof payload crosses this server/client boundary. */
export function MassEnergyDerivation() {
  return (
    <details id="me-ledger-derivation" data-ledger-disclosure className="local-steps">
      <summary>Follow the checked ledger subtraction step by step</summary>
      <LazyLinearProofExplorer proof={generated as LinearProofView} />
    </details>
  );
}
