...
describe("the whole-paper page", () => {
  test("holds a link in place of every passage's steps, and the section page holds the steps", () => {
...
describe("extractSteps", () => {
  test("lifts one passage's steps from its section page, without the summary", () => {
    const placeholders = mountWholePage();
  ...
  test("a page without the passage, or a malformed id, gives null", () => {
...
describe("loadStepsBody", () => {
  test("fills every passage, fetching each section page once, and mounts constructions at their level", async () => {
    const placeholders = mountWholePage();
    const calls: string[] = [];
    const mounts: string[] = [];
  ...
  test("a failed load keeps the link, says so once, and loads on the next opening", async () => {
  ...
  test("a placeholder naming no section page is refused without a fetch", async () => {
    const [p] = mountWholePage();
