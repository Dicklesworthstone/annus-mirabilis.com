...
export function NotebookLauncher() {
  ...
  return (
    <>
      <a ref={trigger} href="/notebook/">Notebook</a>
      <div className="notebook-host" ref={host} />
      {failed && <span role="status">Notebook controls could not load. Reload to try again; reading is unaffected.</span>}
    </>
  );
}
