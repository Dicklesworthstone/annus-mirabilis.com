...
export function replayEnvironment(replay: ComparisonReplay): ReplayViewEnvironment {
  return {
    ...
    async createRunner() {
      const [{createComparisonReplayRunner}, {createBm01BrowserChannel}, prepared, catalogue] = await Promise.all([
        import("./replayRunner.ts"), import("../../experiments/bm01/browser.ts"),
        import("../../generated/bm01-example.json"), import("../../generated/notebook-replay.json"),
      ]);
      return createComparisonReplayRunner(replay, {
        example: prepared.default, identity: catalogue.default.identity, workerFactory: createBm01BrowserChannel,
      });
    },
  };
}
