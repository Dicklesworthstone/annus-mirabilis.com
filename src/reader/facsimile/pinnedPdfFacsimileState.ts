 ...
 * Source path: src/components/patents/pinnedPdfFacsimileState.ts
 * Pinned commit: da11ff475902728fd8dd1d9db9f3af37c16ec8a5
 * License: MIT License (with OpenAI/Anthropic Rider)
 * Preserved license text: /LICENSE
 *
 * Modifications:
 * - Decoupled patent-specific terminology to support Annus Mirabilis historical paper facsimiles.
 * - Preserved pure state reducer, page clamping, and worker URL constants.
 */
...
export interface PinnedPdfFacsimileState {
  ...
  readonly renderState: PinnedPdfRenderState;
