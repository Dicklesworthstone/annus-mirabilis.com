 ...
 * of the paper that makes the same move, or the route's investigation.
 *
 ...
 *
 * The href type admits only those three destinations, so the label is total by construction: a
