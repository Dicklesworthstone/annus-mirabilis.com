...
export const MATHEMATICAL_KINDS = [
  "scalar",
  "vector",
  "vector-component",
  "matrix",
...
export const CONTINUE_WITH_ROUTES = [
  "more-guidance",
  "less-guidance",
] as const;
