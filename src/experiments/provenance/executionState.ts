...
export function deriveHostExecution(
  ...
  if (
    ...
    outputs.some(
      (o) =>
        !Object.hasOwn(contracts, o.quantityId) ||
        o.ownerId !== contracts[o.quantityId]!.ownerId ||
        o.unit !== contracts[o.quantityId]!.unit ||
        o.semanticKind !== contracts[o.quantityId]!.semanticKind,
    )
  )
    return {
      label: "unavailable",
