...
export function metric(label: string, unit: string, result: ScientificResult): ShelfMetric {
  if (
    ...
    throw new ExperimentRuntimeError(
      ...
      `The shelf-optics owner did not return a finite scalar for ${label}.`,
      "shelf-optics",
    );
  }
  return {
  ...
  switch (p.instrumentId) {
    case "shelf-michelson-morley": {
        ...
        return {
          ...
          metrics: [
            ...
            scalar(
              "Leading order in β²",
              "fringes",
              result.expectedFringeShiftFirstOrder,
              "leadingRotationShift",
              "michelsonMorleyFringeShift",
            ),
      ...
      return {
        parameters: p,
        rows,
        primaryMetric: "90° rotation shift",
        later: [],
        interpretation:
    ...
    case "shelf-fizeau": {
      ...
      return {
        parameters: p,
        rows,
        primaryMetric: "Signed fringe shift",
        later,
    ...
    case "shelf-maxwell-galilean": {
        ...
        return {
          ...
          metrics: [
            ...
            scalar(
              ...
              "s/m",
              result.crossTermCoefficient,
              "mixedDerivativeCoefficient",
              "waveEquationResidual",
            ),
          ],
        };
      ...
      return {
        parameters: p,
        rows,
        primaryMetric: "Residual normalized by k²",
        later: [],
        interpretation:
