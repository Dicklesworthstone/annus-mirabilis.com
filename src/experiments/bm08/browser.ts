...
export function createBm08BrowserChannel(): WorkerChannel {
  const worker = new Worker(new URL("../../workers/host/bm08Worker.ts", import.meta.url), { type: "module", name: "Annus Mirabilis camera observation" });
  return {
