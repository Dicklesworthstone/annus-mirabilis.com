...
const definitions = {
  "transport-error": {
    message: "The calculation channel could not deliver its message.",
    retry: "retry-same-request",
  },
  "protocol-mismatch": {
    message: "The page and calculation engine use different message versions.",
    retry: "reload",
  },
  "malformed-response": {
    message: "The calculation returned a response that could not be validated.",
    retry: "new-run",
  },
  "budget-exhausted": {
  ...
  cancelled: {
    message: "This calculation was stopped before completion.",
    retry: "retry-same-request",
  },
  ...
  "artifact-mismatch": {
    message: "The calculation module does not match the verified edition.",
    retry: "reload",
  },
  "environment-unsupported": {
    message: "This device does not provide the features this calculation needs.",
    retry: "none",
  },
  "worker-crashed": { message: "The calculation worker stopped unexpectedly.", retry: "new-run" },
  "context-lost": {
    message: "The graphics context was lost; the accepted calculation is preserved.",
    retry: "retry-same-request",
  },
  "invariant-violation": {
