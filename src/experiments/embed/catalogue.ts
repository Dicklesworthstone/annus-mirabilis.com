...
export const EMBED_INSTRUMENTS = [
  {
    id: "bm-03", title: "Counting configurations and osmotic pressure",
    ...
    steps: "Follow one particle, two particles, the logarithm for many particles, and finally the volume derivative. Inspect the named assumptions before interpreting the pressure.",
  },
  {
    id: "lq-05", title: "Independent configurations and the gas analogy",
    ...
    steps: "Start with one point, increase the point count, then lock the positions. Compare the resulting volume dependence. The counting argument is a premise for the radiation analogy, not by itself a demonstration of light quanta.",
  },
  {
    id: "lq-06", title: "Matching the radiation and gas entropy coefficients",
    ...
    steps: "Inspect the radiation coefficient, the independent-particle coefficient, and the effective count that makes them agree. Check the constant set and the stated Wien-regime limitation before carrying the result into emission or absorption.",
  },
  {
    id: "sr-04", title: "Constructing the coordinate map",
    ...
    steps: "Inspect the forward and backward light constraints separately. Add reciprocity, isotropy, and the identity branch, then check transverse light. Later mathematical aids are checks, not premises smuggled into the construction.",
  },
  {
    id: "me-01", title: "Opposite pulses and two energy ledgers",
    ...
    steps: "Follow the moving pulses, their angle-free sum, both balances, the subtraction, and the kinetic-energy interpretation. The light-energy transformation is an imported premise; a mass-energy formula is not installed as the starting answer.",
  },
  {
    id: "me-02", title: "Inertia from the small-speed coefficient",
    ...
    steps: "Inspect the unchanged-offset premise, the exact kinetic drop, and the coefficient of the squared speed. Vary the speed to see the approximation's range; do not divide a zero-speed measurement by zero to manufacture an inertia estimate.",
  },
  {
    id: "shelf-michelson-morley", title: "Optical arm times with and without contraction",
    ...
    steps: "Inspect both round-trip times, their difference, and the predicted change after a right-angle rotation. Compare the exact model with the leading low-speed approximation. The supplied calibration is modern and illustrative, not a strict 1904 dataset.",
  },
  {
    id: "shelf-fizeau", title: "Moving-water drag hypotheses",
    source: "/discover/special-relativity/",
    ...
    steps: "Inspect the assumed drag coefficient, both path speeds, and the predicted fringe difference. The opt-in relativistic comparison is a later development, not evidence used to justify the earlier hypotheses. No historical observation is supplied by this preview.",
  },
  {
    id: "shelf-maxwell-galilean", title: "Wave equations under a change of coordinates",
    ...
    steps: "Inspect the mixed-derivative term and both residuals for Galilean and Lorentz substitutions. This scalar diagnostic is not the complete Maxwell-Hertz field derivation. Continue to the full reading for the field transformations.",
  },
] as const;
