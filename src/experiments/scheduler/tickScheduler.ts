 ...
 * Source path: src/physics/tickScheduler.ts
 * Pinned commit: da11ff475902728fd8dd1d9db9f3af37c16ec8a5
 * License: MIT License (with OpenAI/Anthropic Rider)
 * Preserved license text: /LICENSE
 *
 * Modifications:
 * - Removed patent-specific references in comments.
 * - Preserved TickScheduler and createStudioClock with host-pumped time and bounded catch-up.
 */

/**
 * Host-pumped tick scheduler.
...
/** Host-fed rAF clock for catalog 3Ds / visual instruments. Bounded catch-up; no fake 1/60 physics dt. */
