...
export const SR08_CAPTION = Object.freeze({
  ...
  r1: "Under a boost along x, the parallel field components are unchanged while perpendicular components mix with factor gamma. The field combinations E·B and E² - c²B² are Lorentz invariants.",
