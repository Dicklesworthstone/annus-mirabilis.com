    ...
    <>
      ...
      <section className="reading" id="radiation-entropy-theory">
        ...
        <p>
          ...
          dependence of the spectral entropy density <InlineFormula latex={String.raw`\varphi`} />.
          Maximizing <InlineFormula latex={String.raw`S = v\int\varphi(\rho,\nu)\,d\nu`} /> at fixed
          energy, together with <InlineFormula latex="dS = dE/T" />, gives:
        </p>
        ...
        <p>
          ...
          density <InlineFormula latex={String.raw`\varphi`} /> vanishes when the radiation density{" "}
          <InlineFormula latex={String.raw`\rho`} /> is zero.
        </p>
        ...
        <p>
          ...
          energy <InlineFormula latex="E" /> in volume <InlineFormula latex="v" /> depends on volume
          exactly the way the entropy of an ideal gas or a dilute solution does:
        </p>
        <Formula
          latex={String.raw`\begin{gathered}S - S_0 = \frac{E}{\beta\nu}\ln\frac{v}{v_0} \\ (\text{printed "lg" is the natural logarithm})\end{gathered}`}
        />
        <p>
          Only after this volume law is established does identifying{" "}
          <InlineFormula latex={String.raw`\beta = h/k_B`} /> give the modern form{" "}
          <InlineFormula latex={String.raw`\Delta S = k_B\,\frac{E}{h\nu}\ln\frac{V}{V_0}`} />. The
          coefficient <InlineFormula latex={String.raw`E/(h\nu)`} /> emerges from an entropy
        ...
        <p>
          Had the integration constant <InlineFormula latex={String.raw`C(\nu)`} /> been left
          unfixed rather than set to zero by the boundary condition, it would contribute an extra
          term proportional to <InlineFormula latex="(V - V_0)" /> that does not cancel and does not
          reproduce the volume law. The workbench&apos;s teaching panel above makes this concrete
          with an illustrative nonzero <InlineFormula latex={String.raw`C(\nu)`} />.
        </p>
