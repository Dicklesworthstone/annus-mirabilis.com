  ...
  return (
    <>
      ...
      <section className="reading" id="inference-argument">
        ...
        <Formula
          latex={String.raw`\widehat D=\frac{1}{2dM\Delta t}\sum_{i=1}^{M}\lVert\Delta\mathbf r_i\rVert^2,\qquad q=dM`}
        />
        <p>
        ...
        <p>
          ...
          determination. Reviewed historical observations, independent gas-constant measurements,
          and camera-error models are not supplied here.
        </p>
        <p>
