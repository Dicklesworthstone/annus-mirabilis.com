  ...
  return (
    <>
      ...
      <section className="reading" id="photoelectric-theory">
        ...
        <p>
          When <Formula latex={String.raw`\nu < \nu_0`} />, the stopping potential is strictly not
          applicable (a typed non-value), never zero, because no emitted photoelectrons exist to be
          retarded. Millikan 1916 is later historical evidence on the timeline, never an axiom of
          the 1905 derivation.
        </p>
