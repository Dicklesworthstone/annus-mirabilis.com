...
export const metadata = {
  title: "Foundations for the Brownian argument",
  ...
  return (
    <>
      <header className="page-intro">
        <p className="eyebrow">A finite path through the prerequisites</p>
        <h1>
          Start with the idea
          <br />
          that is missing.
        ...
        <p className="lead">
          Each lesson includes a worked example and a stopping point. Follow the prerequisites as
          far as you need, then return to the argument.
        </p>
        <p className="fine">
