...
const host = createBm07Host(message => {
  ...
  if (workerData.breakArray && message.messageKind === "result" && message.result.kind === "accepted") message.result.data.outputs.find(o => o.quantityId === "observationIncrements").value = new Float64Array(2);
