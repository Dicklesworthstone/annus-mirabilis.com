...
typographicalErrors:
  - id: "typo-h-for-y-axis-p899"
    ...
    proposedCorrection: "auf die Y- und Z-Achse angewandt"
    reasoning: "Reproduces the real record shape that shipped before am-59wk."
    evidence: "Real historical shape: printedPage flat instead of a locator, proposedCorrection instead of proposedReading, plus status/action/foundBy that the type never declared. This is the shape a retraction was written into, which is why the retraction reached nothing."
    status: "withdrawn-not-an-error"
    action: "The ledger keeps the original reading."
