import { KITCHEN_COLUMNS, KITCHEN_METADATA_KEYS } from "../../experiments/bm07/kitchen/schema.ts";
export function kitchenFixture({ metadata = {}, points = undefined } = {}) {
  const m = {
    ...
    viscosity_mpa_s: "1",
    viscosity_source: "Declared synthetic teaching parameter, not measured water",
    radius_um: "",
    radius_interval_um: "",
