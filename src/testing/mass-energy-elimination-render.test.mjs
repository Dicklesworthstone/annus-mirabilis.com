...
const generated = JSON.parse(
  await readFile(new URL("../generated/mass-energy-elimination.json", import.meta.url), "utf8"),
);
...
test("the generated proof is a rendering of the exact five-step certificate", () => {
  ...
  for (const equation of generated.equations) {
    ...
    for (const field of ["html", "mathml", "plainLatex", "treeDigest", "spoken"])
      assert.equal(equation[field], actual[field]);
