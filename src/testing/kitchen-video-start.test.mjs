...
import { appendVideoPoint, frameStamp, startCapture, videoGeometry } from "../experiments/bm07/kitchen/videoCapture.ts";
...
test("particle capture cannot lock an uncalibrated session into an unusable state", () => {
  ...
  assert.equal(state.kind, "ready"); assert.equal(frame.kind, "ready");
