...
describe("am-eq-genealogy-hmm: validateGenealogyConsistency", () => {
  ...
  test("detects premise cycles in directed graph", () => {
    ...
    const graph: GenealogyGraph = {
      ...
      perspective: "historical",
      nodes: [
        { id: "a", paper: "sr", label: "A", type: "equation", isRoot: false, isNumberedResult: false },
        { id: "b", paper: "sr", label: "B", type: "equation", isRoot: false, isNumberedResult: false },
        { id: "c", paper: "sr", label: "C", type: "equation", isRoot: false, isNumberedResult: false },
      ],
      edges: cyclicEdges,
      roots: [],
      crossPaperEdges: [],
