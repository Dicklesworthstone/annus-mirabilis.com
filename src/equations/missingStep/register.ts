...
if(!getClarificationKind("derivation-step"))registerClarificationKind("derivation-step",{
  parseId:resolve,
  staticHref:({lesson,step})=>`/papers/brownian-motion/s4/?open=derivation-step:${step.id}#${lesson.argument}`,
