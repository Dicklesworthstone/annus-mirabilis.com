...
describe("Equation Alternate Forms Validation", () => {
  ...
  describe("Canonical Test Pair: Genuine Unit Conversion vs Rename-Only Alternate", () => {
    ...
    test("rename-only alternate is REJECTED with 'alternate-is-rename'", () => {
  ...
  describe("Required-Fields Enforcement and Type Contract", () => {
    ...
    test("unit-conversion missing 'unitSystem' fails rule 'unit-conversion-missing-fields'", () => {
    ...
    test("unit-conversion missing 'derivationChainId' fails rule 'unit-conversion-missing-fields'", () => {
      const missingChain = {
        id: "eq-s6-d3.alt.si",
        relation: "unit-conversion",
        label: "SI units form",
    ...
    test("modernization missing 'modernLensRef' fails rule 'modernization-missing-fields'", () => {
      const missingLens = {
    ...
    test("modernization missing or invalid 'historicalStatus' fails rule 'modernization-missing-fields'", () => {
      const invalidStatus = {
        id: "eq-s6-d3.alt.modern",
        relation: "modernization",
        label: "Modern form",
