...
export const FOUNDATION_QUANTITIES: QuantityRegistry = Object.freeze(
  Object.fromEntries(
    [
      ...
      own({
        id: "velocityComponentX",
        name: "Velocity along x",
        glyph: "v_x",
        dimension: ["1", "0", "-1", "0", "0", "0"],
        unit: "m/s",
        displayUnit: "m/s",
        displayPower: 0,
        semanticKind: "velocity-component",
        role: "input",
        // Shared by the equipartition and vectors lessons: a molecule's velocity is one case.
        definition: "v_x: the part of a velocity along one chosen direction, the x axis.",
      }),
      own({
        id: "velocityComponentY",
        name: "Velocity along y",
        glyph: "v_y",
        dimension: ["1", "0", "-1", "0", "0", "0"],
        unit: "m/s",
        displayUnit: "m/s",
        ...
        semanticKind: "velocity-component",
        role: "input",
        definition: "v_y: the part of the same velocity along the y axis, at right angles to x.",
      }),
      own({
        ...
        role: "result",
        definition:
          "|v|: the length of the velocity arrow, the speed, which no choice of axes changes.",
      }),
      own({
        id: "stokesDragForce",
        name: "Drag force",
        ...
        semanticKind: "force",
        role: "result",
        definition: "F: the force a liquid exerts on a sphere moving slowly through it.",
      }),
      ...
      // The dissertation's viscosity relation, as the two-measurements lesson states it.
      own({
        id: "solutionViscosity",
        name: "Viscosity of the solution",
        glyph: "\\eta^*",
        dimension: ["-1", "1", "-1", "0", "0", "0"],
        unit: "Pa*s",
        displayUnit: "Pa*s",
        displayPower: 0,
        semanticKind: "viscosity",
        role: "input",
        definition: "η*: the viscosity of the water with the substance dissolved in it.",
      }),
      own({
        id: "viscosityCoefficientPhi",
        name: "Coefficient of φ in the viscosity law",
        glyph: "c",
        dimension: dimensionless,
        unit: "1",
        displayUnit: "1",
        displayPower: 0,
        semanticKind: "dimensionless-coefficient",
        role: "constant",
        definition:
          "c: the coefficient of the volume fraction φ, 1 as printed in 1906 and 5/2 after the 1911 correction.",
      }),
      own({
        id: "molarConcentration",
        name: "Moles dissolved per unit volume",
        glyph: "n",
        dimension: ["-3", "0", "0", "0", "0", "1"],
        unit: "mol/m^3",
        displayUnit: "mol/m^3",
        displayPower: 0,
        semanticKind: "molar-concentration",
        role: "input",
        definition: "n: the number of moles of the dissolved substance in each unit of volume.",
      }),
